 ...
 */
export function resolveOrigins(configured: Array<string>, nodeEnv: string | undefined, productionOrigin?: string): Array<string> {
...
export function corsHeaders(origins: Array<string>, requestOrigin: string | undefined): Record<string, string> {
...
export function preflightHeaders(origins: Array<string>, requestOrigin: string | undefined): Record<string, string> {
